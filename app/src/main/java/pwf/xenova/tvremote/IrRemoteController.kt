...
enum class RemoteAction {
    ...
    MENU, EXIT, BACK, HOME, GUIDE, HDMI, INFO, CH_LIST, SOURCE,
...
class IrRemoteController(context: Context) {
    ...
    private val codeTable: Map<TvBrand, Map<RemoteAction, Pair<Int, Int>>> = mapOf(
        TvBrand.SAMSUNG to mapOf(
            ...
            RemoteAction.CH_LIST to (0x07 to 0x6B),
            RemoteAction.SOURCE to (0x07 to 0x01),
        ...
        TvBrand.LG to mapOf(
            ...
            RemoteAction.CH_LIST to (0x04 to 0xF0),
        ...
        TvBrand.SONY to mapOf(
            ...
            RemoteAction.CH_LIST to (0x01 to 0x81),
        ...
        TvBrand.GENERIC_NEC to mapOf(
            ...
            RemoteAction.UP to (0x00 to 0x40),
            RemoteAction.DOWN to (0x00 to 0x41),
            RemoteAction.LEFT to (0x00 to 0x42),
            RemoteAction.RIGHT to (0x00 to 0x43),
            RemoteAction.OK to (0x00 to 0x44),
            RemoteAction.MENU to (0x00 to 0x45),
            RemoteAction.EXIT to (0x00 to 0x46),
            RemoteAction.BACK to (0x00 to 0x47),
            RemoteAction.HOME to (0x00 to 0x48),
            RemoteAction.GUIDE to (0x00 to 0x49),
            RemoteAction.HDMI to (0x00 to 0x4A),
            RemoteAction.INFO to (0x00 to 0x4B),
            RemoteAction.CH_LIST to (0x00 to 0x4C),
            RemoteAction.SOURCE to (0x00 to 0x4A),
        ...
        TvBrand.PANASONIC to mapOf(
            RemoteAction.POWER to (0x40 to 0x3D),
            RemoteAction.VOL_UP to (0x40 to 0x20),
            RemoteAction.VOL_DOWN to (0x40 to 0x21),
            RemoteAction.MUTE to (0x40 to 0x22),
            RemoteAction.CH_UP to (0x40 to 0x24),
            RemoteAction.CH_DOWN to (0x40 to 0x25),
            RemoteAction.UP to (0x40 to 0x2C),
            RemoteAction.DOWN to (0x40 to 0x2D),
            RemoteAction.LEFT to (0x40 to 0x2E),
            RemoteAction.RIGHT to (0x40 to 0x2F),
            RemoteAction.OK to (0x40 to 0x30),
            RemoteAction.MENU to (0x40 to 0x06),
            RemoteAction.EXIT to (0x40 to 0x64),
            RemoteAction.BACK to (0x40 to 0x37),
            RemoteAction.HOME to (0x40 to 0x60),
            RemoteAction.GUIDE to (0x40 to 0x6A),
            RemoteAction.HDMI to (0x40 to 0x50),
            RemoteAction.INFO to (0x40 to 0x38),
            RemoteAction.CH_LIST to (0x40 to 0x1A),
            RemoteAction.SOURCE to (0x40 to 0x50),
            RemoteAction.NUM_1 to (0x40 to 0x01),
            RemoteAction.NUM_2 to (0x40 to 0x02),
            RemoteAction.NUM_3 to (0x40 to 0x03),
            RemoteAction.NUM_4 to (0x40 to 0x04),
            RemoteAction.NUM_5 to (0x40 to 0x05),
            RemoteAction.NUM_6 to (0x40 to 0x06),
            RemoteAction.NUM_7 to (0x40 to 0x07),
            RemoteAction.NUM_8 to (0x40 to 0x08),
            RemoteAction.NUM_9 to (0x40 to 0x09),
            RemoteAction.NUM_0 to (0x40 to 0x00)
        ),
        TvBrand.TCL_HISENSE to mapOf(
            RemoteAction.POWER to (0x00 to 0x0C),
            RemoteAction.VOL_UP to (0x00 to 0x1A),
            RemoteAction.VOL_DOWN to (0x00 to 0x1E),
            RemoteAction.MUTE to (0x00 to 0x0F),
            RemoteAction.CH_UP to (0x00 to 0x12),
            RemoteAction.CH_DOWN to (0x00 to 0x13),
            RemoteAction.UP to (0x00 to 0x50),
            RemoteAction.DOWN to (0x00 to 0x51),
            RemoteAction.LEFT to (0x00 to 0x52),
            RemoteAction.RIGHT to (0x00 to 0x53),
            RemoteAction.OK to (0x00 to 0x54),
            RemoteAction.MENU to (0x00 to 0x0E),
            RemoteAction.EXIT to (0x00 to 0x14),
            RemoteAction.BACK to (0x00 to 0x1D),
            RemoteAction.HOME to (0x00 to 0x58),
            RemoteAction.GUIDE to (0x00 to 0x59),
            RemoteAction.HDMI to (0x00 to 0x1B),
            RemoteAction.INFO to (0x00 to 0x5A),
            RemoteAction.CH_LIST to (0x00 to 0x5B),
            RemoteAction.SOURCE to (0x00 to 0x1B),
            RemoteAction.NUM_1 to (0x00 to 0x00),
            RemoteAction.NUM_2 to (0x00 to 0x01),
            RemoteAction.NUM_3 to (0x00 to 0x02),
            RemoteAction.NUM_4 to (0x00 to 0x03),
            RemoteAction.NUM_5 to (0x00 to 0x04),
            RemoteAction.NUM_6 to (0x00 to 0x05),
            RemoteAction.NUM_7 to (0x00 to 0x06),
